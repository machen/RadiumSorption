...
fileLocation = "RaCaCl2Oxic\\" #Working folder, which contains the input folder and output
dataFile = 'RaCaCl2Oxic.xlsx' #Name of files
resultFile ='RaCaCl2Oxic Equilibrated Data.xlsx'
