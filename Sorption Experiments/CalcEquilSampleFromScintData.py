...
fileLocation = "RaPYRSingleSalt\\" #Working folder, which contains the input folder and output
dataFile = 'RaPYRSingleSalt.xlsx' #Name of files
resultFile ='RaPYRSingleSalt Equilibrated Data.xlsx'
