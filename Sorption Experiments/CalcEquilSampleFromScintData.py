...
fileLocation = "RaGlass_May11_2017\\" #Working folder, which contains the input folder and output
dataFile = 'RaGlass_May11_2017.xlsx' #Name of files
resultFile ='RaGlass_May11_2017 Equilibrated Data.xlsx'
