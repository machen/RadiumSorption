...
fileLocation = "RaPYR_pH9\\" #Working folder, which contains the input folder and output
dataFile = 'RaPYR_pH9_NoScript.xlsx' #Name of files
resultFile ='RaPYR_pH9 Equilibrated Data.xlsx'
