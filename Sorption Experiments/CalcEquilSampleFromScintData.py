...
fileLocation = "RaMont_pH7\\" #Working folder, which contains the input folder and output
dataFile = 'RaMont_pH7_Kinetics_NoScript.xlsx' #Name of files
resultFile ='RaMont_pH7_Kinetics Equilibrated Data.xlsx'
