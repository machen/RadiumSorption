...
fileLocation = "RaCaMont_pH7\\" #Working folder, which contains the input folder and output
dataFile = 'RaCaMont_pH7_Kinetics_NoScript.xlsx' #Name of files
resultFile ='RaCaMont_pH7_Kinetics Equilibrated Data.xlsx'
