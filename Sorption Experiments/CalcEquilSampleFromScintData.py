...
fileLocation = "RaFHYArtificialWater2\\" #Working folder, which contains the input folder and output
dataFile = 'RaFHYArtificialWater2.xlsx' #Name of files
resultFile ='RaFHYArtificialWater2 Equilibrated Data.xlsx'
